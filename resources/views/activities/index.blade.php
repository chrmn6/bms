                    ...
                    <table class="table-auto mt-3 w-full border border-gray-300 dark:border-gray-600">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-700">
                                ...
                                <th class="px-4 py-2 border border-gray-300 dark:border-gray-600">Date & Time</th>
                        ...
                        <tbody>
                            @foreach($activities as $activity)
                                <tr class="border-b border-gray-200 dark:border-gray-600">
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-600">{{ $activity->title }}
                                    </td>
                                    ...
                                    <td
                                        class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-center
                                                        {{ $activity->status == 'completed' ? 'text-green-600 font-semibold' : '' }}
                                                        {{ $activity->status == 'canceled' ? 'text-red-600 font-semibold' : '' }}
                                                        {{ $activity->status == 'scheduled' ? 'text-yellow-600 font-semibold' : '' }}">
