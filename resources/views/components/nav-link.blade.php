...
@php
    $classes = ($active ?? false)
        ? 'block pl-4 py-2 border-l-4 !border-[#6D0512] dark:!border-[#6D0512] text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-800 font-medium transition duration-150 ease-in-out'
