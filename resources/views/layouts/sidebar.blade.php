    ...
    <div class="h-full overflow-y-auto bg-neutral-50 dark:bg-gray-800">
        <ul class="space-y-1 font-medium">
            ...
            @if($user->role === 'admin')
                ...
                <li>
                    <x-sidebar-link :href="route('admin.budget.index')" :active="request()->routeIs('admin.budget.index')">
                        <span class="inline-flex items-center">
                            <svg class="w-[20px] h-[20px] mr-2 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                            ...
                            <span x-show="sidebarOpen">Financial</span>
                        </span>
                    </x-sidebar-link>
                </li>
                ...
                <li>
                    <x-sidebar-link :href="route('admin.staff.index')" :active="request()->routeIs('admin.staff.index')">
                        <span class="inline-flex items-center">
                            ...
                            <span x-show="sidebarOpen">Staff List</span>
                        </span>
                    </x-sidebar-link>
                </li>
            @endif
