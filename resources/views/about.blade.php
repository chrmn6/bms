    ...
    <div
        ...
        <main class="flex flex-col-reverse lg:flex-row w-full max-w-4xl items-center lg:items-stretch mx-auto gap-x-8">
            ...
            <div class="flex-1 p-6 pb-12 lg:p-18 flex flex-col justify-center text-[#1b1b18] dark:text-[#EDEDEC]">
                <h1 class="mb-1 font-bold text-3xl uppercase">
                    About Us
                </h1>
                <p class="mt-2 text-[#706f6c] dark:text-[#A1A09A] text-sm sm:text-base text-justify leading-relaxed">
                    The Barangay Matina Gravahan Management System provides a centralized online space where residents
                    can request documents, view
                    barangay updates, access
                    programs and services. It was developed to promote transparency, improve service delivery, and
