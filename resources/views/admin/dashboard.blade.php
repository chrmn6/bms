<x-app-layout>
    ...
    <div class="main-content container-fluid py-8">
                ...
                <div class="welcome-card">
                    <div class="welcome-content">
                        <div class="welcome-icon">
                            <i class="bi bi-{{ date('H') < 12 ? 'sun' : (date('H') < 18 ? 'sun' : 'moon-stars') }}"></i>
                        </div>
                        <div class="welcome-text">
                            ...
                            <p class="welcome-subtitle">Welcome to the Barangay Matina Gravahan Management System.
                                Here's an overview of today's activities.</p>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="quick-actions-section">
                    <div class="section-header">
                        ...
                        <p class="section-subtitle">Frequently used actions for efficient workflow</p>
                    </div>
                    <div class="actions-grid">
                        <a href="{{ route('announcements.index') }}" class="action-card info-action">
                        ...
                        <a href="{{ route('clearances.index') }}" class="action-card warning-action">
                            <div class="action-icon">
                                <i class="bi bi-file-earmark-check"></i>
                            </div>
                            <div class="action-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center text-muted py-4">
                            ...
                            <a href="{{ route('announcements.index') }}" class="btn btn-primary">Create First
                                Announcement</a>
                        </div>
                        @endif
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3 pb-3 border-bottom">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <small class="text-muted">
                                    ...
                                    <i class="bi bi-calendar"></i> {{ $activity->date->format('M d, Y') }}
                                </small>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="text-center text-muted py-4">
                            ...
                            <a href="{{ route('activities.index') }}" class="btn btn-success">Schedule Activity</a>
                        </div>
                        @endif
                    </div>
                </div>
