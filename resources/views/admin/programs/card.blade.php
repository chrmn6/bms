<div class="space-y-6 sm:space-y-4">
    @forelse($programs as $program)
        <div class="flex gap-3 sm:gap-6">
            <div
                class="program-card bg-slate-50 block max-w-md p-4 border border-default rounded-md shadow-md hover:shadow-lg transition-shadow">
                ...
                @can('update', $program)
                    <x-primary-button type="button" hx-get="{{ route('admin.programs.edit', $program->program_id) }}"
                        hx-target="#editProgramModalBody" hx-swap="innerHTML" data-bs-toggle="modal"
